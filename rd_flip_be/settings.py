"""
Django settings for rd-flip-be.
"""
...
WSGI_APPLICATION = "rd_flip_be.wsgi.application"
ASGI_APPLICATION = "rd_flip_be.asgi.application"
...
AUTH_USER_MODEL = "rd_flip_be.User"
...
REST_FRAMEWORK = {
    # JWT ready for per-view auth later (permission_classes = [IsAuthenticated])
